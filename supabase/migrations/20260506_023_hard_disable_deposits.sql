-- Migration 023: HARD DISABLE DEPOSITS
-- This is a temporary measure to ensure no deposits are calculated
-- while we investigate the schema cache issue.
...
DECLARE
  ...
  v_deposit_amount      NUMERIC(10,2) := 0; -- HARDCODED TO 0
...
BEGIN
  ...
  -- 5. Commission (manual bookings only)
