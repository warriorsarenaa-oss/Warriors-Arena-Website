...
function SuccessScreen({
  ...
  const fallbackWhatsapp = "201226557592";
  const whatsappNumber = contactData?.contact_whatsapp || fallbackWhatsapp;
...
function WizardContent() {
  ...
  if (confirmed) {
    return <SuccessScreen data={confirmed} contactData={contactData} onClose={closeWizard} t={t} isRtl={isRtl} />;
  }
