      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-end md:items-center justify-center p-0 pt-10 md:p-6 pb-0 md:pb-6">
          ...
          <motion.div 
            ...
            className="bg-wa-bg w-full max-h-[90vh] overflow-hidden relative border-t md:border border-wa-green/20 shadow-[0_0_50px_rgba(0,255,65,0.1)] flex flex-col
          ...
          >
            ...
            {/* Scrollable Content */}
            <div className="flex-1 overflow-y-auto custom-scrollbar p-6 pt-12 md:p-12">
              {children}
            </div>
          </motion.div>
        </div>
